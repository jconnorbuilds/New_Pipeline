    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor_code', models.CharField(blank=True, max_length=8, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_status', models.CharField(choices=[('NR', 'Not ready to request'), ('READY', 'Ready to request'), ('REQ', 'Requested'), ('REC', 'Received via upload'), ('REC2', 'Received (direct PDF/paper)'), ('ERR', 'Error on upload'), ('PAID', 'Paid'), ('NA', 'No Invoice')], default='NR', max_length=50)),
