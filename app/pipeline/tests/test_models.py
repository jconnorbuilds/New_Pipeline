...
#     proper_name = factory.lazy_attribute(lambda o: o.friendly_name + ", Inc.")
#     proper_name_japanese = "株式会社オレンジ"
#     job_code_prefix = factory.lazy_attribute(
#         lambda o: "".join(
#             random.choices([*o.friendly_name.replace(" ", "").upper()], k=3)
#         )
#     )
...
#     job_type = Job.JOB_TYPE_CHOICES[random.randint(0, len(Job.JOB_TYPE_CHOICES))][0]
#     personInCharge = "JC"
#     status = "ONGOING"
#     isDeleted = False
...
#         job_codes["jc3"] = self.job.set_job_code(prefix="BBB", year=2023, month=10)
#         JobFactory(job_code=job_codes["jc3"], job_code_isFixed=True)

#         job_codes["jc4"] = self.job.set_job_code(prefix="BBB", year=2023, month=11)
