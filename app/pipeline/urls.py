...
urlpatterns = [
    ...
    path('pl-job-update/<pk>/', views.PipelineJobUpdateView.as_view(),
         name="pipeline-update-job"),
    path('set-client-invoice-info/<pk>/',
         views.SetInvoiceInfoView.as_view(), name="set-client-invoice-info"),
    path('set-deposit-date/<pk>/', views.SetDepositDateView.as_view(),
    ...
    path('prepare-batch-payment/', views.create_batch_payment_file,
    ...
    path('request-single-invoice/<cost_id>/',
         views.RequestVendorInvoiceSingle, name="request-single-invoice"),
    ...
    path('client-details/<pk>', views.ClientDetailView.as_view(),
         name="client-details"),
    ...
    path('vendor-update/<pk>', views.VendorUpdateView.as_view(),
         {"success": None}, name="vendor-update"),
    path('remove-vendor-from-job/<job_id>/<pk>/',
         views.VendorRemoveFromJob, name="remove-vendor-from-job"),
    path('no-invoices/', views.invoice_error, name="no-invoices"),
    path('process-uploaded-vendor-invoice/', views.process_uploaded_vendor_invoice,
         name="process-uploaded-vendor-invoice"),
    path('pipeline-data/<int:year>/<int:month>/',
         views.pipeline_data, name="pipeline-data"),
    path('pipeline-data/', views.pipeline_data, name="pipeline-data"),
    path('revenue-data/<int:year>/<int:month>/',
         views.revenue_display_data, name="revenue-data"),
